...
class MarketServiceTest extends TestCase
{
    ...
    {
        $this->assertEqualsWithDelta($expectedResult,$this->market->calculateWeightProfitQuotient($testProfit, $testWeight), 0,000000001 );
    }
    ...
    public function getProfitAndWeight(): array
    {
        return[
            [125000, 50, 2500],
            [125000, 2000,62.5 ],
            [18203859, 2700, 6742.17],
            [9664554, 6900, 1400.66],
            [125000, 25000, 5],
        ];
    }
}